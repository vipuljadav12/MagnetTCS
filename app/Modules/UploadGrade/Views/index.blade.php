                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 col-lg-3">
                            <div class="form-group">
                                ...
                                <div><small><em style="font-weight: 600; font-size: 12px;">If your student application number e.g. SPECIAL-2223-9999 then please enter last 4 digit e.g. 9999</em></small></div>
                            </div>
                        </div>
                        <div class="col-12 col-lg-3">
                            <div class="form-group">
