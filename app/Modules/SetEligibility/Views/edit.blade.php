...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        function setDataForPopUp(element, extra_val=0) {
            ...
            let url = "{{url('admin/SetEligibility/extra_values/session?')}}"+data;
            window.location = url;
        ...
        function setDataForPopUpSetting(element, extra_val=0) {
            ...
            let url = "{{url('admin/SetEligibility/configurations/session?')}}"+data;
            window.location = url;
    ...
    <script type="text/javascript">
        ...
        /*$('.sp_eligibility').click(function() {
            ...
            $.jquery({
                url: "{{url('admin/SetEligibility/edit/student_profile')}}",
                type: 'POST',
                data: {
                    '_token' => "{{csrf_token()}}",
                    dataset: dataset
