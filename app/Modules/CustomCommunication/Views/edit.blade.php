                                ...
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <select class="form-control custom-select" id="submission_status" name="submission_status">
                                            ...
                                            @endforeach
                                            <option value="Offer Accepted and Contract Pending" @if($data->submission_status == "Offer Accepted and Contract Pending") selected="" @endif class="d-none">Offer Accepted and Contract Pending</option>
