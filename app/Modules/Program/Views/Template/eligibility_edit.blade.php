                        ...
                        <table class="table table-striped mb-0 tbl_eligibility_determination_method">
                            ...
                            @forelse($eligibilities as $key=>$eligibility)
                                ...
                                <tr>
                                        <td class="">
                                            {{$eligibility['name']}}
                                            <input type="hidden" id="grade{{$eligibility['id']}}{{$eid}}" class="gradeval" value="{{(isset($eligibility['program_eligibility']['grade_lavel_or_recommendation_by']) ? str_replace(',','-',$eligibility['program_eligibility']['grade_lavel_or_recommendation_by']) : '')}}" name="grade_lavel_or_recommendation_by[]">
                                        ...
                                        <td class="text-center">
                                                <a href="javascript:void(0);" class="font-18 ml-5 mr-5" title="" onclick="showGradePopup('{{$eligibility['id']}}', '{{$eligibility['name']}}', '{{$eid}}')"><i class="far fa-edit"></i></a>
