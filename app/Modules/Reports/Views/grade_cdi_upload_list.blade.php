...
@section('title')
	TCS Parent Submitted Documents Report
@endsection
@section('content')
<style type="text/css">
    .alert1 {
...
.dt-buttons {position: absolute !important; padding-top: 5px !important;}
    ...
    <div class="card shadow">
        <div class="card-body d-flex align-items-center justify-content-between flex-wrap">
            ...
            <div class=""><a class="text-danger" href="{{url('upload/2/grade')}}" target="_blank"><strong>Add Parent Submitted Documents</strong></a></div>
