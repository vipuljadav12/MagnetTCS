...
@section('title')
	Missing Submission Recommendation Score
@endsection
@section('content')
<style type="text/css">
    .alert1 {
    ...
    <div class="card shadow">
        <div class="card-body">
            @if(count($programs) > 0)
                ...
                <div class="">
                    <a href="javascript:void(0);" onclick="exportReport()" class="btn btn-secondary" title="Export Report">Export Missing Recommendation Score</a>
                </div>
            @else
...
@section('scripts')
	<script type="text/javascript">
        ...
        function exportReport(){
            ...
            var link = "{{url('/')}}/admin/Reports/missing/"+$("#enrollment_option").val()+"/missing_recommendation_score/export/"+program;
