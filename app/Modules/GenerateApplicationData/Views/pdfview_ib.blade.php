    ...
    @foreach($student_data as $value)
        <div class="container page">
          <div class="wrapper">
              ...
              @if(count($value['test_scores']) > 0)
                <div class="section section-2">
                    <div><strong>Student Performance Criteria</strong></div>
                  ...
                  <table class="table text-center"  style="border: none !important">
                      @foreach($value['test_scores'] as $tk=>$tv)
                      <tr  style="border: none !important">
                          <td class="w-50 f-12" style="text-align: left; border: none !important">{{$tk}} : </td>

                          <td class="w-50 f-12" style="text-align: left; border: none !important">{{$tv}}</td>
              ...
              @if(count($value['incidents']) > 0)
              <div class="section section-2">
                    <div><strong>Conduct Criteria</strong></div>
                      <p>Note: Three (3) Most Recent Office Discpline Referrals (ODRS) (Fields will be blank if not applicable)
                    <table class="table text-left">
                      <tbody>

                        @foreach($value['incidents'] as $tk=>$tv)
                          <tr>
                            <td class="f-12">{!! $tv !!}</td>
                          </tr>
                        @endforeach
