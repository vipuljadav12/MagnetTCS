    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-striped mb-0 w-100" id="datatable2">
                ...
                <tbody>
                    @if(isset($first_audition_processing['offered_arr']))
                        @foreach($first_audition_processing['offered_arr'] as $key=>$value)
                            <tr>
                                ...
                                <td class="text-center committee_score-col">
                                    @if($value['student_profile_score'] != "")
                                        <div class="alert1 alert-success">
                                            {!! $value['student_profile_score'] !!}
                                        </div>
                                    @else
                    ...
                    @if(isset($second_audition_processing['offered_arr']))
                        @foreach($second_audition_processing['offered_arr'] as $key=>$value)
                            <tr>
                                <td class="">{{$value['id']}}</td>
                                <td class="text-center">{{$value['submission_status']}}</td>
                                <td class="hiderace">{{$value['race']}}</td>
                    ...
                    @if(isset($first_audition_processing['waitlisted_arr']))
                        @foreach($first_audition_processing['waitlisted_arr'] as $key=>$value)
                            <tr>
                                <td class="">{{$value['id']}}</td>
                                <td class="text-center">{{$value['submission_status']}}</td>
                                <td class="hiderace">{{$value['race']}}</td>
                    ...
                    @if(isset($second_audition_processing['waitlisted_arr']))
                        @foreach($second_audition_processing['waitlisted_arr'] as $key=>$value)
                            <tr>
                                <td class="">{{$value['id']}}</td>
                                <td class="text-center">{{$value['submission_status']}}</td>
                                <td class="hiderace">{{$value['race']}}</td>
                    ...
                    @foreach($first_audition_processing['no_availability_arr'] as $key=>$value)
                        <tr>
                            <td class="">{{$value['id']}}</td>
                            <td class="text-center">{{$value['submission_status']}}</td>
                            <td class="hiderace">{{$value['race']}}</td>
                    ...
                    @foreach($second_audition_processing['no_availability_arr'] as $key=>$value)
                        <tr>
                            <td class="">{{$value['id']}}</td>
                            <td class="text-center">{{$value['submission_status']}}</td>
                            <td class="hiderace">{{$value['race']}}</td>
                    ...
                    @if(isset($first_audition_processing['in_eligible']))
                        @foreach($first_audition_processing['in_eligible'] as $key=>$value)
                            <tr>
                                <td class="">{{$value['id']}}</td>
                                <td class="text-center">{{$value['submission_status']}}</td>
                                <td class="hiderace">{{$value['race']}}</td>
                    ...
                    @if(isset($second_audition_processing['in_eligible']))
                        @foreach($second_audition_processing['in_eligible'] as $key=>$value)
                            <tr>
                                <td class="">{{$value['id']}}</td>
                                <td class="text-center">{{$value['submission_status']}}</td>
                                <td class="hiderace">{{$value['race']}}</td>
