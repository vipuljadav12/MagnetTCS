    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-striped mb-0 w-100" id="datatable1">
                ...
                <tbody>
                    @if(isset($first_ib_processing['offered_arr']))
                        @foreach($first_ib_processing['offered_arr'] as $key=>$value)
                            <tr>
                    ...
                    @if(isset($second_ib_processing['offered_arr']))
                        @foreach($second_ib_processing['offered_arr'] as $key=>$value)
                            <tr>
                                <td class="">{{$value['id']}}</td>
                                <td class="text-center">{{$value['submission_status']}}</td>
                                <td class="hiderace">{{$value['race']}}</td>
                    ...
                    @if(isset($first_ib_processing['waitlisted_arr']))
                        @foreach($first_ib_processing['waitlisted_arr'] as $key=>$value)
                            <tr>
                                <td class="">{{$value['id']}}</td>
                                <td class="text-center">{{$value['submission_status']}}</td>
                                <td class="hiderace">{{$value['race']}}</td>
                    ...
                    @if(isset($second_ib_processing['waitlisted_arr']))
                        @foreach($second_ib_processing['waitlisted_arr'] as $key=>$value)
                            <tr>
                                <td class="">{{$value['id']}}</td>
                                <td class="text-center">{{$value['submission_status']}}</td>
                                <td class="hiderace">{{$value['race']}}</td>
                    ...
                    @foreach($first_ib_processing['no_availability_arr'] as $key=>$value)
                        <tr>
                            <td class="">{{$value['id']}}</td>
                            <td class="text-center">{{$value['submission_status']}}</td>
                            <td class="hiderace">{{$value['race']}}</td>
                    ...
                    @foreach($second_ib_processing['no_availability_arr'] as $key=>$value)
                        <tr>
                            <td class="">{{$value['id']}}</td>
                            <td class="text-center">{{$value['submission_status']}}</td>
                            <td class="hiderace">{{$value['race']}}</td>
                    ...
                    @if(isset($first_ib_processing['in_eligible']))
                        @foreach($first_ib_processing['in_eligible'] as $key=>$value)
                            <tr>
                                <td class="">{{$value['id']}}</td>
                                <td class="text-center">{{$value['submission_status']}}</td>
                                <td class="hiderace">{{$value['race']}}</td>
                    ...
                    @if(isset($second_ib_processing['in_eligible']))
                        @foreach($second_ib_processing['in_eligible'] as $key=>$value)
                            <tr>
                                <td class="">{{$value['id']}}</td>
                                <td class="text-center">{{$value['submission_status']}}</td>
                                <td class="hiderace">{{$value['race']}}</td>
