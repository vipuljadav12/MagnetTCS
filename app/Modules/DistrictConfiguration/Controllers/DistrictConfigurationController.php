...
class DistrictConfigurationController extends Controller
{
    ...
    { 
        ...
        $recommendation_reminder_data = DistrictConfiguration::where('district_id', $district_id)
            ->whereIn('name', ['missing_recommendation_reminder_email_subject', 'missing_recommendation_reminder_email_body'])
            ->get()->keyBy('name');

        // return $recommendation_reminder_data;
        ...
        */
        ...
        return view("DistrictConfiguration::index", compact('old_email_signature_value', 'old_letter_signature_value', 'contract_accept_screen','recommendation_reminder_data'));//, 'old_timezone'));
    }
...
/*        $rules = [
        ...
        if(isset($request->missing_recommendation_reminder_email_subject)){
            $missing_recomm_subject = [
                'district_id'=>$district_id,
                'name' => 'missing_recommendation_reminder_email_subject',
                'value' => $request->missing_recommendation_reminder_email_subject
            ];

            $result = DistrictConfiguration::updateOrCreate(['district_id'=>$district_id, 'name'=>'missing_recommendation_reminder_email_subject'], $missing_recomm_subject);
        }

        if(isset($request->missing_recommendation_reminder_email_body)){
            $missing_recomm_body = [
                'district_id'=>$district_id,
                'name' => 'missing_recommendation_reminder_email_body',
                'value' => $request->missing_recommendation_reminder_email_body
            ];

            $result = DistrictConfiguration::updateOrCreate(['district_id'=>$district_id, 'name'=>'missing_recommendation_reminder_email_body'], $missing_recomm_body);
        }
