    ...
    <div class="card shadow">
        <div class="card-body">
            ...
            <ul class="nav nav-tabs" id="myTab2" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="missing-recomm-reminder-tab" data-toggle="tab" href="#missing-recomm-reminder-screen" role="tab" aria-controls="missing-recomm-reminder-screen" aria-selected="true">Missing Recommendation Reminder</a>
                </li>
            </ul>
            <div class="tab-content bordered" id="myTab2Content">
                ...
                <div class="tab-pane fade" id="missing-recomm-reminder-screen" role="tabpanel" aria-labelledby="missing-recomm-reminder-tab">
                    <form id="frm_index" action="{{url('admin/DistrictConfiguration/store')}}" method="post" enctype= "multipart/form-data">
                        {{csrf_field()}}
                        <div class="form-group col-12">
                            <label>Mail Subject :</label>
                            <div class="">
                                <input type="text" class="form-control" name="missing_recommendation_reminder_email_subject" id="missing_recommendation_reminder_email_subject" value="{{ ($recommendation_reminder_data['missing_recommendation_reminder_email_subject'] ? $recommendation_reminder_data['missing_recommendation_reminder_email_subject']->value : '') }}">
                            </div>
                        </div>
                        <div class="form-group col-12">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <textarea class="form-control" id="editor03" name="missing_recommendation_reminder_email_body">{!! ($recommendation_reminder_data['missing_recommendation_reminder_email_body'] ? $recommendation_reminder_data['missing_recommendation_reminder_email_body']->value : '') !!}
                                    </textarea>
                                </div>
                            </div>
                        </div>
