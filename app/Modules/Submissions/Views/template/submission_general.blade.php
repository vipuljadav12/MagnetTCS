        ...
        <div class="row">
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12 col-md-12">
                                @php $race_arr = array("African-American - Hispanic", "African-American - Non-Hispanic", "Asian - Hispanic", "Asian - Non-Hispanic", "Hispanic - Hispanic", "Hispanic - Non-Hispanic", "Caucasian - Hispanic", "Caucasian - Non-Hispanic", "American Indian - Hispanic", "American Indian - Non-Hispanic", "Pacific Islander - Hispanic", "Pacific Islander - Non-Hispanic", "White - Hispanic", "White - Non-Hispanic", "Other - Hispanic", "Other - Non-Hispanic"); @endphp
            ...
            <div class="col-12 col-xl-6">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            <label class="control-label col-12 col-md-12">{{getFieldLabel('first_choice') ?? 'First Choice'}} : {{-- {{$submission->first_choice.getProgramName($submission->first_choice)}} --}}</label>
                            <div class="col-12 col-md-12">
                        ...
                        <div class="form-group row">
                            <label class="control-label col-12 col-md-12">{{getFieldLabel('holistic_committee_recommendation') ?? 'Holistic Committee Recommendation '}}  : </label>
                            <div class="col-12 col-md-12">
                                 <select class="form-control custom-select" name="holistic_committee_recommendation" id="holistic_committee_recommendation">
                                    <option value="">Select an Option</option>
                                    <option value="recommend" @if($submission->holistic_committee_recommendation=="recommend") selected="selected" @endif>Recommend</option>
                                    <option value="do_not_recommend" @if($submission->holistic_committee_recommendation=="do_not_recommend") selected="selected" @endif>Do Not Recommend</option>
                                 </select>
                            </div>
                        </div>
                        @endif
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            @if($conduct_display)
                                <a href="{{url('/admin/GenerateApplicationData/generate/individual/IB/'.$submission->id)}}"><i class="fa fa-download  text-success"></i></a>
                            @else
                                <a href="{{url('/admin/GenerateApplicationData/generate/individual/'.$submission->id)}}"><i class="fa fa-download  text-success"></i></a>
                            @endif
                            </div>
                        </div>
                ...
                @if(!empty($manual_email))
                        ...
                        @if(!empty($offer_data) && $offer_data->offer_slug != "" && $submission->submission_status == "Offered")
                            <div class="card shadow">
