...
<form class="form" id="" action="{{url('admin/Submissions/update/ConductDisciplinaryInfo/'.$submission->id)}}" method="post">
    {{csrf_field()}}
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-12 col-md-12">
                        <textarea class="form-control" name="incidents[]" >{!! $incidents[0] ?? '' !!}</textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="control-label col-12 col-md-12 font-weight-bold">Incident 2</label>
                    <div class="col-12 col-md-12">
                        <textarea class="form-control" name="incidents[]">{!! $incidents[1] ?? '' !!}</textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="control-label col-12 col-md-12 font-weight-bold">Incident 3</label>
                    <div class="col-12 col-md-12">
                        <textarea class="form-control" name="incidents[]">{!! $incidents[2] ?? '' !!}</textarea>
                    </div>
                </div> 
