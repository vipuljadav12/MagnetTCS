        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            @if($submission->first_choice != '')
              ...
              @foreach($eligibilities as $key=>$value)
                ...
                @if(in_array($value->eligibility_ype, $available_methods) && $value->eligibility_ype != "Composite Score" && !in_array($value->eligibility_type, $done_arr))
                    ...
                    @php $done_arr[] = $value->eligibility_type @endphp
            ...
            @if($submission->second_choice != '')
              ...
              @foreach($eligibilities_2 as $key=>$value)
                ...
                @if(count($etype_check) <= 0)
                  @if(in_array($value->eligibility_ype, $available_methods_2) && $value->eligibility_ype != "Composite Score" && !in_array($value->eligibility_type, $done_arr))
            ...
            @endif
             ...
             @if((isset($manually_updated) && $manual_processing == "Y") || (isset($offer_data->manually_updated) && $offer_data->manually_updated == "Y"))
        ...
        <div class="tab-content bordered" id="myTabContent">
            ...
            @if($conduct_display)
                  <div class="tab-pane fade" id="incidence-tabcontent" role="tabpanel" aria-labelledby="incidence-tab">
                      ...
                      @include("Submissions::template.submission_conduct_criteria")
                  </div>
             @endif
...
//                    alert("Email Sent Successfully");
        ...
        function fetchStandardGradeManually()
        {
            $("#wrapperloading").show();
             $.ajax({
                type: "get",
                url: '{{url('/')}}/PowerSchool/fetch_standard_grade_single_manual.php?id={{$submission->id}}',
                success: function(response) {
                    var data = response;
                    /* swal({
                        text: "Student Grades Successfully Imported",
