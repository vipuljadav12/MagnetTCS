					...
					{ 
			            ...
			            if (isset($e_temp->id)) {
			                ...
			                if (!empty($wp_email_config)) {
				                ...
				                {
				                	$email_body = $wp_email_config->where('configuration_type', 'parent_email_content')->first()->configuration_value ?? '';

				                	$email_subject = $wp_email_config->where('configuration_type', 'parent_email_subject')->first()->configuration_value ?? '';

				                }
				                else
				                {
				                	$email_body = $wp_email_config->where('configuration_type', 'student_email_content')->first()->configuration_value ?? '';

				                	$email_subject = $wp_email_config->where('configuration_type', 'student_email_subject')->first()->configuration_value ?? '';
