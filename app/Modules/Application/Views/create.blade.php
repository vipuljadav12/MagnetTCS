    ...
    <div class="tab-content bordered" id="myTab2Content">
        <div class="tab-pane fade show active" id="active-screen" role="tabpanel" aria-labelledby="active-screen-tab">
            <div class="">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6">
                        <div class="form-group">
                            <label for="">Specialty Program URL</label>
                            <div class="">
        ...
        <div class="tab-pane fade" id="active1-screen" role="tabpanel" aria-labelledby="active1-screen-tab">
            <div class="form-group">
                ...
                <div class="editor-height-210">
                    <input type="text" class="form-control" class="form-control" name="active_screen_title" value="Your Specialty Schools application has been successfully submitted!">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="editor-height-210">
                    <textarea class="form-control" id="editor00" name="active_screen">
                        ...
                        <p>Please direct all questions about the TCS Specialty Programs to the Office of Specialty Program at xxx@xxx.com or by calling xxx-xxx-xxxx between the hours of 8:30 am and 4:00 pm Monday through Friday.</p>
                    </textarea>
                </div>
            </div>
        </div>
        <div class="tab-pane fade" id="active-email" role="tabpanel" aria-labelledby="active-email-tab">
            <div class="form-group">
                ...
                <div class="editor-height-210">
                    <input type="text" class="form-control" name="active_email_subject" class="form-control" name="active_email_subject" value="Your TCS Speciality Application # {confirm_number}">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="editor-height-210">
                    <textarea class="form-control" id="editor01" name="active_email">
                        ...
                        <p>Your Application Status is <strong>Active.</strong><br />
                            <br />
                            Your Specialty Program application has been successfully submitted!</p>

                            <p>Please direct all questions about the TCS Speciality Application to the Office of Specialty Program at xxx@xxxx.com or by calling 256-428-6987 between the hours of 8:30 am and 4:00 pm Monday through Friday.</p>

                            <p>The office of Specialty Programs is located at 1 Magnum Pass, Mobile, AL 36618</p>
                    </textarea>
                </div>
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <div class="editor-height-210">
                    <textarea class="form-control" id="editor02" name="pending_screen">
                        <p>In order to complete the application process, you must submit a copy of your student's grades and discipline records by {transcript_due_date}. These records should be emailed to xxx@xxxx.com. Please include your confirmation number in your email.</p>

                        <p>Please print this page and/or record this confirmation number for your records. If you provided an email address, you will receive an email confirmation at the email address provided. &nbsp;</p>

                        <p>Please direct all questions about the TCS Speciality Programs application to the Office of Specialty Program at xxx@xxxx.com or by calling 256-428-6987 between the hours of 8:30 am and 4:00 pm Monday through Friday.</p>
                ...
                <div class="editor-height-210">
                    <textarea class="form-control" id="editor03" name="pending_email">
                        ...
                        <p>Your application status is <strong>Pending.</strong><br />
                            <br />
                            Your Specialty Program application has been successfully submitted!&nbsp; In order to complete the application process, you must submit a copy of your student's grades and discipline records by {transcript_due_date}. These records should be emailed to xxx@xxxx.com. Please include your confirmation number in your email.</p>
                            ...
                            <div class="container">
                                <div class="mt-20">
                                    <div class="card aler alert-success p-20 pt-lg-50 pb-lg-150">
                                        ...
                                        <div class="mb-10 text-center" style="text-align: center;"><span style="font-size:16px;">Your application to the Specialty Program for {student_name}, {confirmation_no}, Grades and CDI Submitted Successfully.</span></div>
                                    </div>
                                </div>
                            </div>
                        </main>
