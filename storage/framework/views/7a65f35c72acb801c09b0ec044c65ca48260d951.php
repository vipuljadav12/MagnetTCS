                                ...
                                <div class="col-12 col-lg-6">
                                 ...
                                 <div class="col-12 col-lg-6">
                                    <div class="form-group <?php if($feeder_priority_count == 0): ?> d-none <?php endif; ?>">
                                        ...
                                        <div class="">
                                            <select class="form-control custom-sel2" id="feeder_field" name="feeder_field">
                                                <option value="">Choose an Option</option>
                                    ...
                                    <div class="form-group <?php if($feeder_priority_count == 0): ?> d-none <?php endif; ?>">
                                        ...
                                        <div class="<?php if($program->feeder_field == "upload"): ?> d-none <?php endif; ?>" id="feeder_schools">
                                            <select class="form-control custom-sel2" name="feeder_priorities[]" multiple="">
                                                <option value="">Choose an Option</option>
                                                <?php $__currentLoopData = $schools; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($value->name != ''): ?>
                                                        <option value="<?php echo e(trim($value->name)); ?>" <?php if(in_array(trim($value->name), $feeder_priorities_check)): ?> selected <?php endif; ?>><?php echo e($value->name); ?></option>
                                                    <?php endif; ?>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                        <?php $upload_program_check = explode(",", $program->upload_program_check) ?>
                                        <div class="<?php if($program->feeder_field != "upload"): ?> d-none <?php endif; ?>" id="upload_programs">
                                                <select class="form-control custom-sel2" multiple="" name="upload_program_check[]">
                                                    <option value="">Choose an Option</option>
                                                    <?php $__currentLoopData = $programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($value->name != ''): ?>
                                                            <option value="<?php echo e($value->name); ?>" <?php if(in_array($value->name, $upload_program_check)): ?> selected <?php endif; ?>><?php echo e($value->name); ?></option>
                                                        <?php endif; ?>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
