<?php $__env->startSection('title'); ?>Waitlist Edit Communcation | <?php echo e(config('APP_NAME',env("APP_NAME"))); ?> <?php $__env->stopSection(); ?>
...
<script type="text/javascript">
    ...
    $("#selectform_settings").click(function()
    {
        ...
        document.location.href = "<?php echo e(url('/admin/Waitlist/EditCommunication/application/')); ?>/"+$("#form_field").val();
    })
