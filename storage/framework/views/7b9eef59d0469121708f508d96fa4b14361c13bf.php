    ...
    <div class="card shadow">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <?php if($displayother > 0): ?>
                <li class="nav-item"><a class="nav-link" href="<?php echo e(url('/admin/Waitlist/Population/Version/'.$application_id.'/'.$version)); ?>">Population Changes</a></li>
                <li class="nav-item"><a class="nav-link" href="<?php echo e(url('/admin/Waitlist/Submission/Result/'.$application_id.'/'.$version)); ?>">Submission Results</a></li>
            <?php endif; ?>
        </ul>
