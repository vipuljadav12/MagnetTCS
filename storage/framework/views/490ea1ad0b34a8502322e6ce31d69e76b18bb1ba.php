    ...
    <div class="card shadow">
        <div class="card-body">
            <?php if(count($programs) > 0): ?>
                ...
                <div class="">
                    <a href="javascript:void(0);" onclick="exportReport()" class="btn btn-secondary" title="Export Report">Export Missing Audition</a>
                </div>
            <?php else: ?>
...
<?php $__env->startSection('scripts'); ?>
	<script type="text/javascript">
        ...
        function exportReport(){
            ...
            var link = "<?php echo e(url('/')); ?>/admin/Reports/missing/"+$("#enrollment_option").val()+"/audition/export/"+program;
