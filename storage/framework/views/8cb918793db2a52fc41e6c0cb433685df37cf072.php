...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">
        ...
        {
            $("#wrapperloading").show();
            var  url = "<?php echo e(url('admin/Reports/missing/'.$enrollment_id.'/')); ?>/grade/response";
...
//
        ...
        function exportMissing()
        {
            if($("#enrollment_option").val() == "")
                document.location.href="<?php echo e(url('/admin/Reports/export/missinggrade')); ?>/<?php echo e(Session::get("enrollment_id")); ?>/<?php echo e($late_submission); ?>";
            else
                document.location.href="<?php echo e(url('/admin/Reports/export/missinggrade')); ?>/"+$("#enrollment_option").val() + "/<?php echo e($late_submission); ?>";
