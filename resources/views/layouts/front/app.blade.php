        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="modal-content p-20">
                  <p>{{getConfig()['existing_magnet_student_info'] ?? "The system has identified this student as a current magnet program student.  Students currently enrolled in a magnet program should NOT complete a magnet program application to indicate intention to continue in the program.  You should only continue with the application if you wish to apply for a different magnet program for your student. "}}</p>
...
//                  $("#birthdayFiller").val($("#year").val()+"-"+$("#month").val()+"-"+$("#day").val());
    ...
    function submitForm(event)
    {
      ...
      swal({
          title: '',
          text: "{{strip_tags((getConfig()['form_submit_message'] ?? ''), 'p')}}",
          type: 'warning',
